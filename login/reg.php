	...
	<div class="wrapper">
		<main class="login">
			<div class="login__container">
				<form class="login__form" action="../vendor/signup.php" method="post">
					...
					<div class="login__pass">
						<label for="passconf">Підтвердження пароля</label>
						<input autocomplete="off" class="nameinput" required type="password" name="password_confirm" id="passconf">
					</div>
					<button type="submit" class="login__button">Реєстрація</button>
					<p class="log-link">Уже є акаунт? <a href="../index.php">Заходь!</a></p>
					<?php 
					if ($_SESSION['message']){
